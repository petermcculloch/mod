...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 491.0, 723.0, 186.0, 22.0 ],
					"style" : "",
					"text" : "buffer~ #0_xy 64 2 @samps 64"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 139.0, 28.0, 22.0 ],
									"style" : "",
									"text" : "> 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 503.0, 149.0, 56.0, 22.0 ],
									"style" : "",
									"text" : "buffer xy"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 282.0, 93.0, 125.0, 22.0 ],
									"style" : "",
									"text" : "peek xy @channels 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 352.0, 154.0, 104.0, 22.0 ],
									"style" : "",
									"text" : "in 3 @comment y"
								}
...
, 							{
								"box" : 								{
									"code" : "History read_k(0);\r\nHistory write_k(0);\r\nHistory x(0);\r\nHistory y(0);\r\n\r\nread_k *= (in1==0);\r\nx = latch(in2,in1);\t\r\ny = latch(in2,in1);\t\r\n\r\nwrite_k = (write_k + in1) % in4;\r\n\r\n\r\n// Write \r\npoke(xy, in2, write_k, 0, 0);\r\n\r\n// Read\r\npeek(xy, read_k,0,0);\r\n\r\nread_k = min(read_k+1,in4);\r\nlag_x, lag_y, index_xy = peek(xy,read_k,0,channels=2);\r\n\r\n\r\nout1 = in1 + in2;",
									"fontface" : 0,
									"fontname" : "Arial",
									"fontsize" : 12.0,
									"id" : "obj-5",
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 195.0, 472.0, 198.0 ],
									"style" : ""
								}
...
,
					"patching_rect" : [ 230.0, 346.0, 39.0, 22.0 ],
					"style" : "",
					"text" : "gen~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 567.0, 466.0, 258.0, 22.0 ],
					"style" : "",
					"text" : "PM.NuclearHall~ @wet db -30. @dry db -15."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 424.714294, 329.0, 56.0, 22.0 ],
					"sig" : 0.0,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 342.0, 104.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 342.0, 136.0, 125.0, 22.0 ],
					"style" : "",
					"text" : "reset_when_zero $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 280.0, 188.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 273.0, 248.0, 44.0, 22.0 ],
					"style" : "",
					"text" : "click~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "float" ],
					"patching_rect" : [ 163.0, 388.0, 105.0, 22.0 ],
					"sig" : 0.0,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 40.0, 604.0, 130.0, 130.0 ],
					"range" : [ -5.0, 5.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "float" ],
					"patching_rect" : [ 390.0, 483.0, 127.0, 22.0 ],
					"sig" : 0.0,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "float" ],
					"patching_rect" : [ 262.0, 483.0, 127.0, 22.0 ],
					"sig" : 0.0,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 122.0, 219.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "change~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 387.0, 203.0, 35.0, 22.0 ],
					"style" : "",
					"text" : "sig~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 230.0, 634.0, 49.0, 22.0 ],
					"style" : "",
					"text" : "*~ -0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 230.0, 536.0, 88.0, 22.0 ],
					"style" : "",
					"text" : "tapout~ 1000."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 230.0, 483.0, 151.0, 22.0 ],
					"style" : "",
					"text" : "tapin~ 1000."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 324.714294, 714.0, 130.0, 130.0 ],
					"range" : [ -5.0, 5.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 187.5, 714.0, 130.0, 130.0 ],
					"range" : [ -5.0, 5.0 ],
					"style" : ""
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 329.5, 259.0, 37.0, 22.0 ],
									"style" : "",
									"text" : "out 4"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 144.0, 228.0, 37.0, 22.0 ],
									"style" : "",
									"text" : "out 3"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 599.0, 266.0, 46.0, 22.0 ],
									"style" : "",
									"text" : "history"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 494.799988, 271.0, 46.0, 22.0 ],
									"style" : "",
									"text" : "history"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 355.0, 212.0, 46.0, 22.0 ],
									"style" : "",
									"text" : "history"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 230.0, 212.0, 46.0, 22.0 ],
									"style" : "",
									"text" : "history"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 187.333328, 129.0, 46.0, 22.0 ],
									"style" : "",
									"text" : "history"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 646.0, 735.0, 105.0, 20.0 ],
									"style" : "",
									"text" : "Triple oscillation"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 599.0, 736.0, 37.0, 22.0 ],
									"style" : "",
									"text" : "out 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 599.0, 300.0, 50.0, 22.0 ],
									"style" : "",
									"text" : "sah 0.5"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 494.799988, 305.0, 50.0, 22.0 ],
									"style" : "",
									"text" : "sah 0.5"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 125.0, 745.0, 105.0, 20.0 ],
									"style" : "",
									"text" : "Double oscillation"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 78.0, 746.0, 37.0, 22.0 ],
									"style" : "",
									"text" : "out 1"
								}
...
, 							{
								"box" : 								{
									"code" : "// out1 = (in1==in3) && (in2==in4) && in1 != in2;\r\nParam threshold(0.01);\r\nout1 = abs(in1-in3)<threshold;\r\nout2 = (in1==in4) && (in2==in5) && (in3 == in6) && in1 != in2 && in2 != in3;",
									"fontface" : 0,
									"fontname" : "Arial",
									"fontsize" : 12.0,
									"id" : "obj-13",
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 77.999985, 363.0, 540.0, 343.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 406.0, 245.0, 50.0, 22.0 ],
									"style" : "",
									"text" : "sah 0.5"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 296.666656, 198.0, 50.0, 22.0 ],
									"style" : "",
									"text" : "sah 0.5"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 187.333328, 163.0, 50.0, 22.0 ],
									"style" : "",
									"text" : "sah 0.5"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 588.0, 22.0, 30.0, 22.0 ],
									"style" : "",
									"text" : "in 1"
								}
...
,
					"patching_rect" : [ 222.0, 430.0, 39.0, 22.0 ],
					"style" : "",
					"text" : "gen~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 320.0, 526.0, 130.0, 130.0 ],
					"range" : [ -5.0, 5.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 563.0, 675.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "*~"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"outlettype" : [ "", "float" ],
									"parameter_enable" : 1,
									"patching_rect" : [ 781.200012, 95.912598, 25.0, 36.0 ],
									"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 87.0, -1.0, 37.0, 17.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 100.336914, 0.0, 23.0, 17.0 ],
									"style" : "",
									"text" : "CV",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 716.0, 157.912598, 42.0, 20.0 ],
									"style" : "",
									"text" : "* 0.01"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 698.0, 193.0, 37.0, 20.0 ],
									"style" : "",
									"text" : "*~ 1."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 698.0, 383.0, 58.0, 20.0 ],
									"style" : "",
									"text" : "round~ 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 698.0, 355.0, 110.0, 20.0 ],
									"style" : "",
									"text" : "scale~ -5. 5. 1. 24."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 698.0, 289.0, 32.5, 20.0 ],
									"style" : "",
									"text" : "+~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 765.200012, 242.0, 46.0, 20.0 ],
									"style" : "",
									"text" : "sig~ 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 765.200012, 216.0, 96.0, 20.0 ],
									"style" : "",
									"text" : "scale 1 24 -5. 5."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 698.0, 326.0, 66.0, 20.0 ],
									"style" : "",
									"text" : "clip~ -5. 5."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 698.0, 86.0, 25.0, 25.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "float" ],
									"parameter_enable" : 1,
									"patching_rect" : [ 765.200012, 157.912598, 64.0, 47.0 ],
									"presentation" : 1,
...
,
					"patching_rect" : [ 443.0, 397.0, 122.0, 116.0 ],
					"varname" : "Harmonic[1]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 628.0, 551.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 706.25, 698.0, 130.0, 130.0 ],
					"range" : [ -5.0, 5.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 427.0, 580.0, 53.0, 22.0 ],
					"style" : "",
					"text" : "mode 2"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 563.0, 585.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 644.0, 585.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 521.0, 675.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 521.0, 626.0, 128.0, 22.0 ],
					"style" : "",
					"text" : "MOD.AHD~ 1. 1. 300."
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "int", "int" ],
									"patching_rect" : [ 1022.716675, 734.499939, 50.0, 20.0 ],
									"style" : "",
									"text" : "change"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 553.136963, 317.0, 76.0, 20.0 ],
									"style" : "",
									"text" : "snapshot~ 5"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 645.736938, 244.045105, 50.0, 20.0 ],
									"style" : "",
									"text" : "line~ 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 553.136963, 282.545105, 111.599976, 20.0 ],
									"style" : "",
									"text" : "*~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 645.736938, 168.000061, 42.0, 20.0 ],
									"style" : "",
									"text" : "* 0.01"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 645.736938, 209.000061, 43.0, 19.0 ],
									"style" : "",
									"text" : "$1 20"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 553.136963, 90.000092, 41.0, 20.0 ],
									"style" : "",
									"text" : "mtof~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 553.136963, 61.455048, 114.0, 20.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 1022.716675, 683.999939, 89.0, 18.0 ],
									"style" : "",
...
,
					"patching_rect" : [ 5.0, 50.0, 214.0, 116.0 ],
					"varname" : "CVLFO",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 44.0, 286.0, 48.0, 22.0 ],
					"style" : "",
					"text" : "sig~ 0."
				}
...
,
					"patching_rect" : [ 44.0, 334.0, 122.0, 116.0 ],
					"varname" : "Harmonic",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 180.0, 44.0, 93.0, 22.0 ],
					"style" : "",
					"text" : "receive~ clock"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 916.0, 180.0, 137.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 592.0, 180.0, 137.0, 22.0 ],
					"style" : "",
					"text" : "rampsmooth~ 200 200"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 334.0, 69.0, 50.0, 22.0 ],
					"style" : ""
				}
...
,
					"patching_rect" : [ 916.0, 29.0, 217.0, 116.0 ],
					"varname" : "Quantizer[1]",
					"viewvisibility" : 1
				}
...
, 							{
								"box" : 								{
									...
									"restore" : 									{
										"bypass" : [ 0.0 ],
										"notes" : [ 0, 1, 2, 3, 4, 5, 5, 24, 7, 24, 9, 24, 11, 24 ],
										"rounding" : [ 1.0 ],
										"score" : [ 0.0 ]
									}
,
...
,
					"patching_rect" : [ 592.0, 36.0, 217.0, 116.0 ],
					"varname" : "Quantizer",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 761.0, 574.0, 42.0, 22.0 ],
					"style" : "",
					"text" : "*~ 0.2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 767.0, 483.0, 42.0, 22.0 ],
					"style" : "",
					"text" : "pink~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 755.0, 526.0, 32.5, 22.0 ],
					"style" : "",
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 852.0, 567.0, 130.0, 130.0 ],
					"range" : [ -5.0, 5.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 738.0, 431.0, 38.0, 22.0 ],
					"style" : "",
					"text" : ">~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 916.0, -8.0, 42.0, 22.0 ],
					"style" : "",
					"text" : "*~ 0.2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 592.0, 7.0, 42.0, 22.0 ],
					"style" : "",
					"text" : "*~ 0.2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 628.0, 430.0, 42.0, 22.0 ],
					"style" : "",
					"text" : "*~ 0.1"
				}
...
,
					"patching_rect" : [ 846.0, 225.0, 314.0, 116.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 474.714294, 194.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 424.714294, 194.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 324.714294, 194.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 571.0, 430.0, 42.0, 22.0 ],
					"style" : "",
					"text" : "*~ 0.1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 852.0, 419.0, 130.0, 130.0 ],
					"range" : [ -5.0, 5.0 ],
					"style" : ""
				}
...
,
					"patching_rect" : [ 522.0, 225.0, 314.0, 116.0 ],
					"varname" : "Oscillator",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 422.0, 401.0, 130.0, 130.0 ],
					"range" : [ -5.0, 5.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 584.0, 504.0, 45.0, 45.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 230.0, 208.0, 45.0, 22.0 ],
					"style" : "",
					"text" : ">~ 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 230.0, 154.0, 38.0, 22.0 ],
					"style" : "",
					"text" : "abs~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 230.0, 120.0, 46.0, 22.0 ],
					"style" : "",
					"text" : "delta~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 230.0, 77.0, 78.0, 22.0 ],
					"style" : "",
					"text" : "phasor~ 20."
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 642.0, 557.0, 39.0, 22.0 ],
									"style" : "",
									"text" : "out 3"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 573.0, 557.0, 39.0, 22.0 ],
									"style" : "",
									"text" : "out 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 572.857117, 214.0, 212.0, 22.0 ],
									"style" : "",
									"text" : "in 8 @comment b @min 0. @max 5."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 497.428558, 186.0, 212.0, 22.0 ],
									"style" : "",
									"text" : "in 7 @comment a @min 0. @max 5."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 421.857117, 159.0, 212.0, 22.0 ],
									"style" : "",
									"text" : "in 6 @comment b @min 0. @max 5."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 346.285706, 131.0, 212.0, 22.0 ],
									"style" : "",
									"text" : "in 5 @comment a @min 0. @max 5."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 195.142853, 71.0, 150.0, 22.0 ],
									"style" : "",
									"text" : "in 3 @comment reseedX"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 44.0, 14.0, 134.0, 22.0 ],
									"style" : "",
									"text" : "in 1 @comment clock"
								}
...
, 							{
								"box" : 								{
									"code" : "History x(0);\r\nHistory y(0.5);\r\nHistory xy_at_zero(0);\r\nParam max_zero_cycle(5, min = 1);\r\nParam reset_when_zero(0, min=0,max=1);\r\nclock = in1;\r\nreseed = in2;\r\nnextX = in3;\r\nnextY = in4;\r\n\r\nif (reseed || reset_when_zero && xy_at_zero >= max_zero_cycle) {\r\n\tif (in3 == in4 && in4 == 0) {\r\n\t\tx = noise();\r\n\t\ty = noise();\r\n\t} else {\r\n\t\tx = in3;\r\n\t\ty = in4;\r\n\t}\r\n\tif (x == y && x == 0) {\r\n\t\tx += 0.001;\r\n\t}\r\n\txy_at_zero = 0;\r\n}\r\nif (clock) {\r\n\ta = (1.2*in5) - 3.0; // [-3,3]\r\n\tb = (1.2*in6) - 3.0;\r\n\tc = (0.2*in7) + 0.5; // [0.5,1.5]\r\n\td = (0.2*in8) + 0.5;\r\n\r\n\txnew = sin(y * b) + c * sin(x * b);\n\tynew = sin(x * a) + d * sin(y * a);\n\tx = xnew;\n\ty = ynew;\r\n\t\r\n\tif (abs(x) < 0.00001 && abs(y) < 0.00001) {\r\n\t\txy_at_zero += 1;\r\n\t} else {\r\n\t\txy_at_zero = 0;\r\n\t}\n}\r\n\r\nout1,out2, out3 = x*2., y*2., xy_at_zero;",
									"fontface" : 0,
									"fontname" : "Arial Bold",
									"fontsize" : 12.0,
									"id" : "obj-12",
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 43.999989, 258.0, 548.0, 260.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 119.571419, 41.0, 142.0, 22.0 ],
									"style" : "",
									"text" : "in 2 @comment reseed"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 270.714264, 99.0, 150.0, 22.0 ],
									"style" : "",
									"text" : "in 4 @comment reseedY"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 43.999989, 557.0, 39.0, 22.0 ],
									"style" : "",
									"text" : "out 1"
								}
...
,
					"patching_rect" : [ 195.0, 286.0, 246.0, 22.0 ],
					"style" : "",
					"text" : "gen~"
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-45::obj-28" : [ "Harmonic[1]", "Harmonic", 0 ],
			"obj-29::obj-12" : [ "bypass[1]", "bypass", 0 ],
...
, 			{
				"name" : "PM.NuclearHall~.maxpat",
				"bootpath" : "~/Projects/PM.Max.Private",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "PM.ConvolveZeroLatency~.maxpat",
				"bootpath" : "~/Projects/PM.Max.Private",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "partconvolve~.mxo",
				"type" : "iLaX"
			}
, 			{
				"name" : "timeconvolve~.mxo",
				"type" : "iLaX"
			}
 ],
		"autosave" : 0
